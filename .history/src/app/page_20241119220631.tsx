  ...
  return (
    <div >
			...
			<div style={{padding:"70px"}}>
				...
				<div style={{padding:"70px 0", display:"flex", gap:10}}>
					<div style={{width:"80%"}}>
						<h1 style={{fontSize:"30px", fontWeight:"600" ,borderBottom:"1px solid #DBCDCD"}}>LATEST POSTS</h1>
					...
					<div>
						<h1 style={{fontSize:"30px", fontWeight:"600" ,borderBottom:"1px solid #DBCDCD"}}>RELEASED ALBUMS</h1>
						<div>
