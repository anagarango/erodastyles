				...
				<div>
					...
					<div style={{display:"flex", flexWrap:"wrap"}}>
						{musicalInfluences.map((o,i)=>(
							<div onClick={()=>r.push(`/musicalinfluences/${i}`)} style={{width:"50%", padding:"20px", height:"400px", backgroundImage:`url(/musicalinfluences/${o.cover})`, backgroundSize:"contain", backgroundRepeat:"no-repeat", backgroundPosition:"center"}}>
								<h4 id="heading" style={{fontSize:"25px"}}>{o.title}</h4>
