				...
				<div>
					...
					<div style={{display:"flex", flexWrap:"wrap", gap:"20px", padding:"30px 0"}}>
						{musicalInfluences.map((o,i)=>(
							<div onClick={()=>r.push(`/musicalinfluences/${i}`)} style={{width:"calc(50% - 40px)", padding:"20px", height:"350px", borderRadius: 15, position:"relative", backgroundImage:`url(/musicalinfluences/${o.cover})`, backgroundSize:"cover", backgroundRepeat:"no-repeat", backgroundPosition:"center"}}>
