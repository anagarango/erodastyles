				...
				<div>
					...
					<div style={{display:"flex", flexWrap:"wrap", gap:20}}>
						{musicalInfluences.map((o,i)=>(
							<div onClick={()=>r.push(`/musicalinfluences/${i}`)} style={{width:"49%", padding:"20px", height:"350px", borderRadius: 15, positon:"relative", backgroundImage:`url(/musicalinfluences/${o.cover})`, backgroundSize:"cover", backgroundRepeat:"no-repeat", backgroundPosition:"center"}}>
								<h4 id="heading" style={{backgroundColor:"white", position:"absolute", padding:"50px", top:"45%", left:"40%", fontSize:"25px"}}>{o.title}</h4>
