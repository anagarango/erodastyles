				...
				<div>
					...
					<div style={{display:"flex", flexWrap:"wrap", gap:20}}>
						{musicalInfluences.map((o,i)=>(
							<div onClick={()=>r.push(`/musicalinfluences/${i}`)} style={{width:"49%", padding:"20px", height:"350px", backgroundImage:`url(/musicalinfluences/${o.cover})`, backgroundSize:"cover", backgroundRepeat:"no-repeat", backgroundPosition:"center"}}>
								<h4 id="heading" style={{fontSize:"25px"}}>{o.title}</h4>
