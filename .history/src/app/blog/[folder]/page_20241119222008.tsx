      ...
      <div style={{width:"100%", display:"flex", justifyContent:"center"}}>
        <div style={{display:"flex", flexDirection:"column", alignItems:"center", maxWidth:"1200px"}}>
          ...
          <div style={{padding:"70px"}}>
            ...
            <p style={{paddingBottom:"15px"}}>Grammy-winning artist Harry Styles announced on social media Wednesday (March 23, TODAY!) that his highly anticipated third studio album, Harry’s House, will arrive May 20th.</p>
